...
# Scatter plot avec couleurs selon la variable cible
plt.scatter(df["age"], df["Time"], c=df["Result_of_Treatment"], cmap="coolwarm", edgecolors='k', s=80)

plt.xlabel("Âge")
plt.ylabel("Durée (Time)")
plt.title("Nuage de points : Âge vs Durée, coloré selon le résultat du traitement")
plt.grid(True)
plt.show()
